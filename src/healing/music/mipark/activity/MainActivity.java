package healing.music.mipark.activity;
...
import healing.music.mipark.R;
import healing.music.mipark.adapter.MainAdapter;
import healing.music.mipark.data.Favorite_DBopenHelper;
import healing.music.mipark.data.Main_Data;
import healing.music.mipark.data.Pause_DBOpenHelper;
import healing.music.mipark.mediaplayer.ContinueMediaPlayer;
import healing.music.mipark.util.Crypto;
import healing.music.mipark.util.HangulUtil;
import healing.music.mipark.util.PreferenceUtil;
import healing.music.mipark.util.Utils;
import healing.music.mipark.youtubeplayer.CustomYoutubePlayer;
...
public class MainActivity extends Activity implements OnItemClickListener, OnClickListener, OnScrollListener, AdViewListener, CustomPopupListener, InterstitialAdListener{
	...
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMIXER, "qq98jykk");
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMOB, "ca-app-pub-4637651494513698/6473991129");
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMOB_FULL, "ca-app-pub-4637651494513698/1800248945");
	
//	  Custom Popup 시작
	CustomPopup.setCustomPopupListener(this);
	CustomPopup.startCustomPopup(this, "qq98jykk");
...
//		admobNative.destroy();
	...
	private void init_admob_naive(){
		...
		admobNative.setAdUnitId("ca-app-pub-4637651494513698/3987428586");
		nativeContainer.addView(admobNative);
		admobNative.loadAd(adRequest);
	}
	
	public void addBannerView() {
    	AdInfo adInfo = new AdInfo("qq98jykk");
